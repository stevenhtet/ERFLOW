%compute flows in a network with pinching junctions + tubules;
...
%set up tubule pinches on each edge; here v loops through nodes with index > Ninit
%i.e. the pinch nodes
...
%set up junction pinches; here v loops through the nodes of the original
%graph
for v = 1:Ninit
